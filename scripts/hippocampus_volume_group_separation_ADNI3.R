...
library(readxl)
Hippocampus_values <- read_excel("ADNI combined.xlsx", sheet="sample")
Hippocampus_values <- subset(Hippocampus_values, subset = Hippocampus_values$sample=="ADNI3")
stopifnot(nrow(Hippocampus_values)==575)
...
colnames(Hippocampus_values)[colnames(Hippocampus_values)=="SUMMARYSUVR_WHOLECEREBNORM_1.11CUTOFF"] <-"Amy_status"
