...
COPY model_reg_calibrations /dockerDir/model_reg_calibrations/
...
CMD bokeh serve --port 5006 --allow-websocket-origin='*' --allow-websocket-origin='*:5006' --websocket-max-message-size=40000000 InteractiveVis
